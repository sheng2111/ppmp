...
export default function CreatePPMPPage() {
  ...
  // Office picker — only the user's assigned offices
  ...
  // Pre-select first assigned office if only one
  useEffect(() => {
    const offices = (dbUser as any)?.offices;
    if (offices?.length === 1) {
  ...
  const assignedOffices = (dbUser as any)?.offices || [];

  return (
    <div className="max-w-5xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-semibold text-blue-900">Create PPMP</h1>
          <p className="text-gray-500 text-sm mt-1">
            Fill in the procurement projects for the selected office
          </p>
        </div>
        <button
          ...
          <div>
            ...
            {assignedOffices.length === 0 ? (
              <p className="text-xs text-red-500 mt-1">
                You have no assigned offices. Contact the admin.
              </p>
            ) : (
              <select
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-5">
            ...
            <div className="mb-4">
              ...
              <textarea
                ...
                placeholder="e.g. Supply and delivery of office supplies..."
              />
            </div>
              ...
              <div className="flex flex-wrap gap-2">
                {SUPPORTING_DOCS.map((doc) => (
                  <button
                    ...
                    className={`text-xs px-2.5 py-1.5 rounded-full border transition ${proj.supporting_docs.includes(doc) ? "bg-blue-700 text-white border-blue-700" : "bg-white text-gray-600 border-gray-300 hover:border-blue-400"}`}
                  >
                    {doc}
                  </button>
                ))}
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. Regular office operations"
              />
            </div>
          </div>
              ...
              {proj.lots.map((lot, lIndex) => (
                ...
                >
                  <div className="flex justify-between items-center mb-3">
                    <input
                      className="text-sm font-medium text-blue-800 bg-transparent border-b border-dashed border-blue-300 focus:outline-none focus:border-blue-600 w-24"
                      value={lot.lot_no}
                      onChange={(e) =>
                        updateLot(
                          activeProject,
                  ...
                  <div className="mb-3">
                    ...
                    <textarea
                      ...
                      placeholder="e.g. Office supplies including bond paper..."
                    />
                  </div>
                  <div>
                    <label className="text-xs text-gray-500 mb-1 block">
